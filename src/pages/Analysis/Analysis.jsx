...
const Analysis = () => {
  ...
  async function handleFileChange(event) {
    ...
    if (!inputElement || !inputElement.files) {
      console.error('Error: No files selected or event.target is not a file input');
      return;
    }
    ...
    <>
          ...
          <div className="rectangle__wrapper---skeleton">
            ...
            <div className="text__wrapper--skeleton">
              <div className="text--skeleton">
                {loading ? 'SETTING UP CAMERA...' : 'UPLOADING PHOTO...'}
              </div>
      ...
      <div className="page__analysis">
        ...
        <div className="container__analysis">
              ...
              <div className="rectangle__rotate--wrapper--analysis">
                <div className="rectangle__one--analysis">
                  <div className="rectangle__two--analysis">
                    <div className="rectangle__three--analysis"></div>
                  </div>
                </div>
              </div>
          ...
          <button className="text__left" onClick={handleCamera}>
            ...
            <div className="modal__overlay">
              <div className="modal__container">
                ...
                <div className="buttons__wrapper">
                  ...
                  <button className="allow" onClick={handleCameraAllow}>
                    ALLOW
                  </button>
                </div>
              </div>
          ...
          <button className="text__right" onClick={handleGallery}>
            ...
            <div className="modal__overlay">
              <div className="modal__container">
                ...
                <div className="buttons__wrapper">
                  ...
                  <button className="allow" onClick={handleGalleryAllow}>
                    ALLOW
                  </button>
                </div>
              </div>
